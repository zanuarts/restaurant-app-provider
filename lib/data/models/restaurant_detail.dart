...
List<RestaurantDetail> parseRestaurantDetail(String json){
  ...
  return parsed.map<RestaurantDetail>((json) => RestaurantDetail.fromJson(json)).toList();
}
...
class Restaurant{
  ...
  factory Restaurant.fromJson(Map<String, dynamic> json){
    ...
    List<Categories> restoCategories = category.map((i) => Categories.fromJson(i)).toList();    
    var customerReview = json['customerReviews'] as List;
    List<CustomerReviews> restoReviews = customerReview.map((i) => CustomerReviews.fromJson(i)).toList();    
    return Restaurant(
...
List<CustomerReviews> parseCustomerReviews(String json){
  final parsed = jsonDecode(json).cast<Map<String, dynamic>>();
  return parsed.map<CustomerReviews>((json) => CustomerReviews.fromJson(json)).toList();
}