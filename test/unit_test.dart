...
Future<RestaurantDetail> fetchResto(http.Client client) async {
...
void main() {
  group('Unit testing', () {
    test('return resto detail if successfully', () async {
      ...
      expect(await fetchResto(client), isA<RestaurantDetail>());
    });

    test('throws exception if error', () {
      final client = MockClient();
